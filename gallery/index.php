...
<html xmlns="http://www.w3.org/1999/xhtml">
    <head>
        ...
        <script type="text/javascript">
            ...
            function start(){
                gallery = new Gallery();
                gallery.loader = new GalleryLoader('gallery.xml');
